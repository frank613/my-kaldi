...
if [ $stage -le 1 ]; then
  ...
  lattice-1best --acoustic-scale=100 --lm-scale=0.01 "ark:gunzip -c $dir/lat.JOB.gz|" ark:- \| lattice-align-phones $model ark:- ark:- \| nbest-to-ctm ark:- "$dir/JOB.ctm.ark"  || exit 1;
